...
router
    .group(() => {
        ...
        router
            .patch("/:customer_id/notes/:id", [AdminCustomerNotesController, "update"])
            .as("admin.customers.notes.update");
        router
            .delete("/:customer_id/notes/:id", [AdminCustomerNotesController, "destroy"])
            .as("admin.customers.notes.destroy");
    })
