...
router
    .group(() => {
        ...
        router
            .post("/customers/:id/tags", [AdminCustomerTagsController, "attach"])
            .as("admin.customers.tags.attach");
        router
            .delete("/customers/:id/tags/:tagId", [AdminCustomerTagsController, "detach"])
            .as("admin.customers.tags.detach");
    })
    .prefix("/api/v1/admin")
