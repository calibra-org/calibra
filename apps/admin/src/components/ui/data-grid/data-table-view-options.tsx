                    ...
                    <div className="flex flex-col gap-1 p-2">
                        ...
                        >
                            {(["comfortable", "cozy", "compact"] as const).map((option) => (
                                // oxlint-disable-next-line jsx-a11y/label-has-associated-control -- Radio.Root is a focusable button — wrapping it in a label is the right click-into pattern for Base UI's RadioGroup
                                <label
                                    key={option}
                                    className={cn(
