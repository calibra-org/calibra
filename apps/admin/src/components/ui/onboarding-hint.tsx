...
export interface OnboardingHintProps {
    ...
    id: string;
    /** Lucide icon rendered in the leading slot. Wrapped in a soft tinted circle. */
    icon: LucideIcon;
    title: string;
    ...
    variant?: "inline" | "card";
    /** Override the localized "Dismiss" aria-label. */
    dismissLabel?: string;
    className?: string;
}

/**
 * Empty-state / "next-step" hint card. Dismissal persists across sessions via localStorage.
 * The component renders nothing once dismissed, so it composes naturally inside any container.
 */
